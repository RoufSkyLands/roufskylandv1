...
previewType: "PHOTO",
 thumbnailUrl: photo,
 sourceUrl: 'https://replit.com/@roufskyland'
   }
  },
 text: teks
  };
...
const vid = { url : `wa.me/6281272275593`, type : "video/mp4" }         
...
autolevelup: false 
 ...
 let me = m.sender
let anu = "https://telegra.ph/file/bcc51c3423df47aa2508f.jpg";
...
//AUTO REACT
let regex =[ "bilek","banh","cum","kntl","anjing","mmk","bang","wibu","pantek","pepek","hentai","jmbut"]
for (let i of regex){
...
item1.TEL;waid=${i}:${i}\n
item1.X-ABLabel:Personal Computer (PC)\n
item2.EMAIL;type=INTERNET:nightshadeskyland@gmail.com\n
item2.X-ABLabel:Email\n
item3.URL:https://github.com/RoufSkyLands
...
await ehz.sendMessage(from, { contextInfo: {externalAdReply: {showAdAttribution: true, title: 'SkyLands°᭄ᴮᵒᵗ', mediaType: 3,  renderLargerThumbnail : true,thumbnailUrl: vid.url,sourceUrl: `${sgc}`																												
...
Join group botz
https://chat.whatsapp.com/F7lS7fuRb2AGIVk4x6VFL7
`+readmore+`
...
// Auto Blocked Nomor +1
if (m.sender.startsWith('1')) return ehz.updateBlockStatus(m.sender, 'block')
// Auto Blocked Nomor +48
if (m.sender.startsWith('48')) return ehz.updateBlockStatus(m.sender, 'block')
// ====== GAME FEATURE ========//
...
sourceUrl: 'https://chat.whatsapp.com/F7lS7fuRb2AGIVk4x6VFL7',
mediaType: 1,
renderLargerThumbnail: true 
...
"renderLargerThumbnail": true,
"title": `${botName}`,
"body": 'created by skylands',
"containsAutoReply": true,
"mediaType": 1, 
"thumbnailUrl": 'https://telegra.ph/file/bcc51c3423df47aa2508f.jpg' ,
}
}
},{ 
quoted: m })
...
ehz.sendMessage(6281272275593 + "@s.whatsapp.net",{image: { url: `https://telegra.ph/file/16c9de4909601b42fc994.jpg`}, caption: text12, mentionedJid:[sender], quoted: m })
}
break
case 'accerror': {
if (!isOwner && !isAdmins) return setReply()
let zhiratxt = `_Terima Kasih Atas Laporan Anda! Laporan Sudah Diterima oleh *SkyLands Botz⚡*,Tunggu 1 - 3 Hari Agar Owner Bisa Memperbaikinya_`
...
ehz.sendMessage(from, { contextInfo: {externalAdReply: {showAdAttribution: true, title: `SkyLands°᭄ᴮᵒᵗ`, mediaType: 3,  renderLargerThumbnail : true,thumbnailUrl: 'https://telegra.ph/file/bcc51c3423df47aa2508f.jpg',sourceUrl: `https://wa.me/${nomerOwner}`
...
//======= MENU DOWNLOAD =====//
 case 'ai':
    case 'openai' : {
		if (!q) return setReply(`Ada Yang Bisa SkyLands Bantu?`)			
m.reply(mess.wait)
...
break
      ...
      m.reply('media Akan SkyLands Kirim Lewat Pc')
...
case "fetch":
  if (!q) {
    return m.reply(`Contoh:\n${prefix + command} https://github.com/RoufSkyLands`);
  }
  if (!/^https?:\/\//.test(q)) {
...
ehz.sendMessage(from, { contextInfo: {externalAdReply: {showAdAttribution: true, title: `${botName}`, mediaType: 3,  renderLargerThumbnail : true,thumbnailUrl:"https://telegra.ph/file/bcc51c3423df47aa2508f.jpg",sourceUrl: `https://wa.me/${nomerOwner}`
...
ehz.sendMessage(from, { contextInfo: { externalAdReply: { showAdAttribution: true,
title: `${week} , ${calender}⌟`,previewType:"PHOTO",thumbnail: its,sourceUrl: `https://www.instagram.com/roufskyland`,}
...
ehz.sendMessage(from, { contextInfo: { externalAdReply: { showAdAttribution: true,
title: `${week} , ${calender}ㅤㅤㅤㅤㅤㅤㅤㅤㅤ`,body:`⌜ ${ucapanWaktu} ⌟`,previewType:"PHOTO",thumbnail: its,sourceUrl: `https://www.instagram.com/roufskyland`,}
...
ehz.sendMessage(from, { contextInfo: { externalAdReply: { showAdAttribution: true,
title: `${week} , ${calender}ㅤㅤㅤㅤㅤㅤㅤㅤㅤ`,body:`⌜ ${ucapanWaktu} ⌟`,previewType:"PHOTO",thumbnail: its,sourceUrl: `wa.me/6281272275593`,}
...
ehz.sendMessage(from, { contextInfo: { externalAdReply: { showAdAttribution: true,
title: `EllynChan`,body:`⌜ ${ucapanWaktu} ⌟`,previewType:"PHOTO",thumbnail: its,sourceUrl: `https://www.instagram.com/roufskyland`,}
...
∘ *Menyukai :* ${gai} `
ehz.sendMessage(from, { contextInfo: { externalAdReply: {showAdAttribution: true,
title: `${week} , ${calender}ㅤㅤㅤㅤㅤㅤㅤㅤㅤ`,body:`⌜ ${ucapanWaktu} ⌟`,previewType:"PHOTO",thumbnail: its,sourceUrl: `https://telegra.ph/file/16c9de4909601b42fc994.jpg`,}
}, image: its, caption: teks}, { quoted: m })
}

break
  case 'artinama': {
if (!q) return setReply( `Example : ${prefix + command} Rouf SkyLands`)
...
break
 case 'pasangan': {
if (!q) return setReply( `Example : ${prefix + command} Rouf|Ellyn`)
...
if (!q) return setReply( `Example : ${prefix + command} rouf, 18, 3, 2007, angel, 16, 11, 2007`)
...
case 'kecocokannama': 
case 'cocoknama': {
if (!q) return setReply( `Example : ${prefix + command} Rouf, 18, 3, 2007`)
...
break
case 'jadiannikah': {
if (!q) return setReply( `Example : ${prefix + command} 6, 12, 2024`)
...
break
case 'sifatusaha': {
if (!q) return setReply( `Example : ${prefix + command} 28, 12, 2024`)
let [tgl, bln, thn] = q.split`,`
...
break
    case 'rejeki': 
case 'rezeki': {
if (!q) return setReply( `Example : ${prefix + command} 7, 7, 2024`)
let [tgl, bln, thn] = q.split`,`
...
break
case 'fengshui': {
if (!q) return setReply( `Example : ${prefix + command} Rouf, 1, 2007\n\nNote : ${prefix + command} Nama, gender, tahun lahir\nGender : 1 untuk laki-laki & 2 untuk perempuan`)
...
break
case 'peruntungan': {
if (!q) return setReply( `Example : ${prefix + command} Rouf, 18, 3, 2007, 2025\n\nNote : ${prefix + command} Nama, tanggal lahir, bulan lahir, tahun lahir, untuk tahun`)
...
break
case 'masasubur': {
if (!q) return setReply( `Example : ${prefix + command} 12, 1, 2024, 28\n\nNote : ${prefix + command} hari pertama menstruasi, siklus`)
                ...
                await ehz.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            ...
                            thumbnailUrl: 'https://telegra.ph/file/a91cbe614800ea52b0377.jpg',
                            sourceUrl: '-',
                            mediaType: 1,
                            renderLargerThumbnail: true
                        }
...
break
case 'runtime':{
setReply(`*SkyLands Aktif* ${runtime(process.uptime())}`)
}
break
case 'owner': {
...
break
case 'ehanz': case '@6281272275593': case '62895388738585':
...
thumbnail: fs.readFileSync('./media/thumb.jpeg'),
mediaType:2,
mediaUrl: 'https://telegra.ph/file/bcc51c3423df47aa2508f.jpg', } },},{quoted:fkontak})               
}
break
...
var hasil = pickRandom(gheayubi)
ehz.sendMessage(m.chat, { caption: 'nih bang rouf\ningat jangan Gamon yak\nellyn udah pergi;)', video: { url: hasil.url }}, { quoted: m })
break
case 'tiktokbocil':
setReply(mess.wait)
...
ehz.sendMessage(owner + "@s.whatsapp.net",{image: { url: `https://telegra.ph/file/16c9de4909601b42fc994.jpg`}, caption: text12, mentionedJid:[sender], quoted: m })
}
break
case 'accpesanan': {
if (!isOwner && !isAdmins) return setReply()
...
let link = 'https://telegra.ph/file/bcc51c3423df47aa2508f.jpg'
...
m.reply(`Harap Bersabar Dan Tunggu 1-24 Jam Proses unbanned Menggunakan Bot SkyLands Botz⚡\nDilarang Spam Unbanned Agar Akun WhatsApp Anda Tidak Terkena Banned Permanent!`)
m.reply(mess.wait)
