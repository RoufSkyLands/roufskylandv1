...
if(usePairingCode && !ehz.authState.creds.registered) {
		const phoneNumber = await question('MASUKKAN NOMOR DENGAN AWALAN 62 UNTUK MENDAPATKAN PAIRING CODE || BUY SC CHAT 6281272275593\n');
 ...
 //=================================================//
   ehz.sendImageAsSticker = async (jid, media, m, options = {}) => {
    ...
    let jancok = new Sticker(media, {
        pack:"SkyLands°᭄ᴮᵒᵗ", // The pack name
        author:"Created By SkyLandsBotz",// The author name
  ...
  title:"SkyLands°᭄ᴮᵒᵗ",body: `${textT}`,previewType:"PHOTO",thumbnail: fs.readFileSync('./media/thumb.jpeg'),
...
connectToWhatsApp();
  ...
  ehz.sendMessage('6281272275593' + "@s.whatsapp.net", { text: `Halo Skylands Udah Aktif Nih!  
